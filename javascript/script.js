...
function updateTimer() {
  const targetDate = new Date("february 1, 2025 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543777217743'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543777217743'; // Número para el primer botón
